...
import com.dc.ufscar.compiladores.semantico2.JanderParser.Exp_aritmeticaContext;
import com.dc.ufscar.compiladores.semantico2.JanderParser.ExpressaoContext;
import com.dc.ufscar.compiladores.semantico2.JanderParser.FatorContext;
import com.dc.ufscar.compiladores.semantico2.JanderParser.Fator_logicoContext;
...
public class JanderSemanticoUtils {
    ...
    public static TipoJander getTipo(String strTipoVar) {
        TipoJander tipoVar = TipoJander.INVALIDO;

        switch (strTipoVar.replace("^", "").toUpperCase()) {
            case "INTEIRO":
    ...
    public static TabelaDeSimbolos.TipoJander verificarTipo(TabelaDeSimbolos tabela,
        ...
        for (TermoContext ta : ctx.termo()) {
            ...
            if (ret == null) {
                ...
                adicionarErroSemantico(ctx.getStart(), "atribuicao nao compativel para " + nomeVar);
